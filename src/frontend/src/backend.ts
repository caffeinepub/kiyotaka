...
export class Backend implements backendInterface {
    ...
    async createSignal(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createSignal(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCandleData(arg0: string, arg1: string): Promise<Array<Candle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCandleData(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopGainers(): Promise<Array<Coin>> {
        if (this.processError) {
            try {
    ...
    async getTopLosers(): Promise<Array<Coin>> {
        if (this.processError) {
            try {
    ...
    async removeHolding(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async toggleAlert(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleAlert(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateHolding(arg0: string, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateHolding(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
